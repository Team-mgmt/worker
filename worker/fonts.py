...
as qmr-web's TeacherFontService consumes). The worker only needs to *render*
...
# admins can edit via the qmr-web UI. The string is interpolated into both a
...
# ``s3://<env>-qmr-assets/common/fonts/``).
