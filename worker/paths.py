...
# Useful for utilizing instance storage on EC2 (e.g., /mnt/nvme/shelfalign-worker)
STORAGE_DIR = os.getenv("WORKER_STORAGE_DIR", "/tmp/shelfalign-worker")
