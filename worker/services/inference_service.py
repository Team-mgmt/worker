    ...
    for ocr in request.ocr_results:
        ...
        detection_results.append(
            DetectionResult(
                ...
                detection_confidence=ocr.detection_confidence,
                obb_polygon=ocr.obb_polygon,
                crop_method=ocr.crop_method,
                crop_size=ocr.crop_size,
                ocr_variant=ocr.ocr_variant,
                ocr_attempt_count=ocr.ocr_attempt_count,
                ocr_label_text=ocr.ocr_label_text,
                ocr_label_confidence=ocr.ocr_label_confidence,
