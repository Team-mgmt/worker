...
- 전체 manifest: [training/manifests/project-2-all.csv](/abs/path/C:/dev/ShelfAlign/training/manifests/project-2-all.csv)
- 답안 버블 manifest: [training/manifests/project-2-problem.csv](/abs/path/C:/dev/ShelfAlign/training/manifests/project-2-problem.csv)
- 변환 스크립트: [training/src/export_labelstudio_dataset.py](/abs/path/C:/dev/ShelfAlign/training/src/export_labelstudio_dataset.py)
