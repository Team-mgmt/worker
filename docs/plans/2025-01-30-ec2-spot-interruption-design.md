...
Run: `cd /home/swjeon/projects/shelfalign-worker && uv run python -c "from worker.worker.spot import SpotInterruptionMonitor; print('OK')"`
Expected: `OK`
...
Run: `cd /home/swjeon/projects/shelfalign-worker && uv run python -m mypy worker/main.py worker/worker/spot.py --show-error-context`
...
Run: `cd /home/swjeon/projects/shelfalign-worker && uv run python -m ruff check worker/`
Expected: No new errors

**Step 2: Run mypy type checker**

Run: `cd /home/swjeon/projects/shelfalign-worker && uv run python -m mypy worker/ --show-error-context`
Expected: No new errors

**Step 3: Test import and basic instantiation**

Run: `cd /home/swjeon/projects/shelfalign-worker && uv run python -c "from worker.worker.spot import SpotInterruptionMonitor; m = SpotInterruptionMonitor(lambda: print('shutdown')); print('Monitor created OK')"`
