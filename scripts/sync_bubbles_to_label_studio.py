...
SOURCE_BUCKET_DEFAULT = "dev-shelfalign-assets"
SOURCE_PREFIX_DEFAULT = "shelfalign-worker/debug"
DEST_BUCKET_DEFAULT = "dev-hi4labs-label-studio"
DEST_PREFIX_DEFAULT = "shelfalign-worker"
...
def build_task(
    *,
    ...
    return {
        ...
        "predictions": [
            {
                "model_version": f"shelfalign-worker.v{metrics.version}",
                "score": score,
                "result": [
                    {
                        "from_name": "verdict",
...
def main(argv: list[str] | None = None) -> int:
    ...
    p.add_argument("--profile", default="shelfalign", help="AWS_PROFILE to use (default: shelfalign)")
