...
Usage:
    AWS_PROFILE=qmr uv run python scripts/extract_smoke_fixture.py <scan-request-id>
...
def s3_cp(bucket: str, key: str, dest: Path) -> None:
    ...
    subprocess.check_call(
        ...
        env={**os.environ, "AWS_PROFILE": os.environ.get("AWS_PROFILE", "qmr")},
    )
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help="S3 bucket (default: $S3_BUCKET_NAME or dev-qmr-assets)",
    )
